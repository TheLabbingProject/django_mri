    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('study_groups', models.ManyToManyField(blank=True, related_name='mri_scans', to='tests.Group')),
                ('subject', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='mri_scans', to='tests.Subject')),
            ],
            options={
