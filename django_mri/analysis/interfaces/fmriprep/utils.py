...
COMMAND = "singularity run -e -B {bids_parent}:/work,{destination_parent}:/output,{freesurfer_license}:/fs_license /my_images/fmriprep-{version}.simg /work/{bids_name} /output/{destination_name} {analysis_level} --fs-license-file /fs_license"  # noqa: E501
