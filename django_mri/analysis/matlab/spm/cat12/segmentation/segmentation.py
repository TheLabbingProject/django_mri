"""
Definition of the
:class:`~django_mri.analysis.matlab.spm.cat12.segmentation.segmentation.Segmentation`
class.
"""
...
class Segmentation(SPMProcedure):
    ...
    def transform_options(self) -> dict:
        ...
        :mod:`~django_mri.analysis.matlab.spm.cat12.segmentation.transformations`
        module to the
