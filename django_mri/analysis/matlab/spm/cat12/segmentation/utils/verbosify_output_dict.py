...
def verbose_surface_estimation(output_dict: dict) -> dict:
...
def verbosify_label_files(output_dict: dict) -> dict:
    label_files = [
...
def verbosify_deformation_fields(output_dict: dict) -> dict:
...
def verbosify_reports(reports: list) -> dict:
    return {
...
def verbosify_output_dict(output_dict: dict) -> dict:
    result = verbose_surface_estimation(output_dict)
    result.update(verbosify_label_files(output_dict))
