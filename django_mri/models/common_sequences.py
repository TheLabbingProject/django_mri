...
sequences = [
    {
        ...
        "sequence_definitions": [
            {"scanning_sequence": ["GR", "IR"], "sequence_variant": ["SK", "SP", "MP"]}
        ],
    },
    {
        "title": "Localizer",
        ...
        "sequence_definitions": [
            {"scanning_sequence": ["GR"], "sequence_variant": ["SP", "OSP"]}
        ],
    },
    {
        "title": "IR-EPI",
        ...
        "sequence_definitions": [
            {"scanning_sequence": ["EP", "IR"], "sequence_variant": ["SK", "SP", "MP"]},
            {
    ...
    },
    {
        ...
        "sequence_definitions": [
            {"scanning_sequence": ["EP"], "sequence_variant": ["SK", "SS"]}
        ],
    },
]
